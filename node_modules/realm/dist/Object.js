...
class RealmObject {
    ...
    linkingObjects(objectType, propertyName) {
        const realm = this[exports.REALM];
        ...
        const accessor = (0, internal_1.createResultsAccessor)({ realm, typeHelpers, itemType: 7 /* binding.PropertyType.Object */ });
        // Create the Result for the backlink view.
        const tableRef = internal_1.binding.Helpers.getTable(realm.internal, targetObjectSchema.tableKey);
        const tableView = this[exports.INTERNAL].getBacklinkView(tableRef, targetProperty.columnKey);
        const results = internal_1.binding.Results.fromTableView(realm.internal, tableView);
        return new internal_1.Results(realm, results, accessor, typeHelpers);
    }
    /**
    ...
    getPropertyType(propertyName) {
        ...
        if (typeName === "mixed") {
            ...
            else if (value === internal_1.binding.ListSentinel) {
                return "list";
            }
            else if (value === internal_1.binding.DictionarySentinel) {
                return "dictionary";
            }
