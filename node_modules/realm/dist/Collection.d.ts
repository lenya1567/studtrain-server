import type { DictionaryAccessor, OrderedCollectionAccessor, TypeHelpers } from "./internal";
import { CallbackAdder, binding } from "./internal";
/**
 * Collection accessor identifier.
 * @internal
 */
export declare const COLLECTION_ACCESSOR: unique symbol;
/**
 * Collection type helpers identifier.
 * @internal
 */
export declare const COLLECTION_TYPE_HELPERS: unique symbol;
/**
 ...
 * @since 0.11.0
 */
export declare abstract class Collection<KeyType = unknown, ValueType = unknown, EntryType = [KeyType, ValueType], T = ValueType, ChangeCallbackType = unknown, 
/** @internal */
Accessor extends CollectionAccessor<ValueType> = CollectionAccessor<ValueType>> implements Iterable<T> {
    /**
     * Accessor for getting and setting items in the binding collection.
     * @internal
     */
    ...
    private listeners;
    /** @internal */
    constructor(accessor: Accessor, typeHelpers: TypeHelpers<ValueType>, addListener: CallbackAdder<ChangeCallbackType, binding.NotificationToken, [string[] | undefined]>);
    /**
