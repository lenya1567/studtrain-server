...
class Realm {
    ...
    static setLogLevel(level, category = "Realm") {
        (0, internal_1.assert)(internal_1.LOG_CATEGORIES.includes(category), `Unexpected log category: '${category}'`);
        const categoryRef = internal_1.binding.LogCategoryRef.getCategory(category);
        categoryRef.setDefaultLevelThreshold((0, internal_1.toBindingLoggerLevel)(level));
    }
    static setLogger(loggerCallback) {
        internal_1.assert.function(loggerCallback);
        internal_1.binding.Logger.setDefaultLogger((0, internal_1.toBindingLogger)(loggerCallback));
    }
    /**
    ...
    static shutdown() {
        ...
        internal_1.binding.Logger.setDefaultLogger(null);
        internal_1.garbageCollection.collect();
    }
    /**
    ...
    objects(type) {
        ...
        const table = internal_1.binding.Helpers.getTable(internal, objectSchema.tableKey);
        const results = internal_1.binding.Results.fromTable(internal, table);
        const typeHelpers = {
            fromBinding(value) {
        ...
        const accessor = (0, internal_1.createResultsAccessor)({ realm: this, typeHelpers, itemType: 7 /* binding.PropertyType.Object */ });
        return new internal_1.Results(this, results, accessor, typeHelpers);
    }
    /**
...
(function (Realm) {
    ...
    Realm.Counter = internal.Counter;
